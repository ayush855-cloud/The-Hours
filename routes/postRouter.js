...
const {createPost,fetchPosts,fetchPost,updatePost,updateValidations, updateImage,deletePost,home,postDetails,postComments} =require('../controllers/postController'); 
...
router.post("/comment",auth,postComments);
